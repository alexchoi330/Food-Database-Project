...
<html>
    ...
    <body>
        ...
        <form method="GET" action="projectJoin.php"> <!--refresh page when submitted-->
            <input type="hidden" id="joinQueryRequest" name="joinQueryRequest">
            Condition: type in an email = <input type="text" name="joinValue"> <br /><br />
		Note: no need for apostrophes here <br /><br />
	...
	<form method="POST" action="project.php">
        ...
        function printResult($result) { //prints results from a select statement
            ...
            echo "<table>";
            echo "<tr><th>email</th><th>password</th><th>name</th><th>age</th><th>b_date</th><th>gender</th><th>weight</th><th>g_name</th></tr>";
        ...
        function handleJoinRequest() {
            ...
            $result = executePlainSQL("select * from users INNER JOIN has_goals on (users.email = has_goals.u_email) where users.email = '".$joinVal."'");
